...
## Setting Up R   
  ...
  >Note: If you are using a 32bit Operating system then the latest R Studio 1.2.xxx will not support in your machine. You can download older version 1.1.xxx from the below link

<http://download1.rstudio.org/RStudio-1.1.463.exe>
